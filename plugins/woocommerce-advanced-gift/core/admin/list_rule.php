...
//                        $res = 'Days: ' . $days . ' H : ' . $hours;
                        ...
                        $output .= '
                            <tr  id="' . get_the_ID() . '" data-active-status="' . $status . '">
                                ...
                                <td>
                                    <a class="pw-action-icon" href="' . admin_url('admin.php?page=rule_gift&tab=add_rule&pw_action_type=edit&pw_id=' . get_the_ID()) . '"><i class="fa fa-pencil"></i></a>
                                    <a class="pw_delete_gift_rule pw-action-icon" href="' . admin_url('admin.php?page=rule_gift&pw_action_type=delete&pw_id=' . get_the_ID()) . '"><i class="fa fa-trash-o"></i></a>
                                </td>
                            </tr>';
                    }
                endwhile;
