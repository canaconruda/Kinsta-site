...
//add_action('freshio_woocommerce_single_product_dokan', 'freshio_dokan_sold_store', 1);
...
add_filter('loop_shop_columns', function ($columns){
    if(is_product()){
        ...
        $product_single_style = freshio_get_theme_option('single_product_gallery_layout', 'horizontal');
