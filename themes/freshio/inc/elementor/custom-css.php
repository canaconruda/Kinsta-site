...
class Freshio_Elementor_Custom_Css {
	...
	public function add_scripts_editor() {
		global $freshio_version;
			wp_enqueue_script( 'freshio-elementor-custom-css', get_theme_file_uri( '/assets/js/elementor-custom-css.js' ), [], $freshio_version, true );
	}
	...
	public function register_controls( Controls_Stack $element, $section_id ) {
		...
		$element->start_controls_section(
			'section_custom_css',
			[
				'label' => esc_html__( 'Custom CSS', 'freshio' ),
		...
		$element->add_control(
			'custom_css_title',
			[
				'raw' => esc_html__( 'Add your own custom CSS here', 'freshio' ),
		...
		$element->add_control(
			...
			[
				'raw' => wp_kses_post(__( 'Use "selector" to target wrapper element. Examples:<br>selector {color: red;} // For main element<br>selector .child-element {margin: 10px;} // For child element<br>.my-class {text-align: center;} // Or use any custom selector', 'freshio' )),
				'type' => Controls_Manager::RAW_HTML,
...
return new Freshio_Elementor_Custom_Css();
