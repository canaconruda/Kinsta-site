<?php
if ( ! function_exists( 'freshio_elementor_get_render_attribute_string' ) ) {
	function freshio_elementor_get_render_attribute_string($element, $obj) {
		return $obj->get_render_attribute_string($element);
	}
}
if ( ! function_exists( 'freshio_elementor_parse_text_editor' ) ) {
	function freshio_elementor_parse_text_editor( $content, $obj ) {
...
if ( ! function_exists( 'freshio_elementor_get_strftime' ) ) {
	function freshio_elementor_get_strftime( $instance, $obj ) {
		$string = '';
