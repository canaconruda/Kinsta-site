 ...
 * @since 1.0.0
 */
class Freshio_Elementor_Brand extends Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__('Brands', 'freshio');
    }
    ...
    public function get_script_depends() {
        return ['freshio-elementor-brand', 'slick'];
    }
    ...
    protected function _register_controls() {
        ...
        $this->start_controls_section(
            'section_brands',
            [
                'label' => esc_html__('Brands', 'freshio'),
            ]
        );
        ...
        $repeater->add_control('brand_title',
            [
                'label'       => esc_html__('Brand name', 'freshio'),
                'type'        => Controls_Manager::TEXT,
                'default'     => esc_html__('Brand Name', 'freshio'),
                'placeholder' => esc_html__('Brand Name', 'freshio'),
                'label_block' => true,
            ]
        );
        ...
        $repeater->add_control('type_brand',
            [
                'label'   => esc_html__('Type', 'freshio'),
                'type'    => Controls_Manager::SELECT,
                'options' => [
                    'image' => esc_html__('Image', 'freshio'),
                    'icon'  => esc_html__('Icon & SVG', 'freshio'),
                ],
                'default' => 'image',
            ]
        );
        ...
        $repeater->add_control('brand_image',
            [
                'label'     => esc_html__('Choose Image', 'freshio'),
        ...
        $repeater->add_control('link',
            [
                'label'       => esc_html__('Link to', 'freshio'),
                'type'        => Controls_Manager::URL,
                'dynamic'     => [
                    'active' => true,
                ],
                'placeholder' => esc_html__('https://your-link.com', 'freshio'),
            ]
        );
        ...
        $this->add_control(
            'brands',
            [
                'label'       => esc_html__('Brand Items', 'freshio'),
        ...
        $this->start_controls_section(
            'style_brand_wrapper',
            [
                'label' => esc_html__('Wrapper', 'freshio'),
        ...
        $this->add_responsive_control(
            'image_padding',
            [
                'label'      => esc_html__('Padding', 'freshio'),
        ...
        $this->add_responsive_control(
            'image_margin',
            [
                'label'      => esc_html__('Margin', 'freshio'),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => ['px', 'em', '%'],
                'selectors'  => [
        ...
        $this->start_controls_section(
            'style_brand_icon',
            [
                'label' => esc_html__('Icon & SVG', 'freshio'),
                'tab'   => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'icon_color_hover',
            [
                'label'     => esc_html__('Primary Color', 'freshio'),
                'type'      => Controls_Manager::COLOR,
                'selectors' => [
                        ...
                        <div <?php echo freshio_elementor_get_render_attribute_string('item', $this); // WPCS: XSS ok. ?>>
                            <div class="elementor-brand-image">
                                ...
                                if (!empty($item['link'])) {
                                    ...
                                    echo '<a href="' . esc_url($item['link']['url'] ? $item['link']['url'] : '#') . '" ' . freshio_elementor_get_render_attribute_string('brand-image', $this) . ' title="' . esc_attr($item['brand_title']) . '">';
                                }
                                ...
                                if ($item['type_brand'] == 'image') {
                                    ...
                                    if ($is_new || $migrated) {
                                        ...
                                        <i <?php echo freshio_elementor_get_render_attribute_string('icon', $this); // WPCS: XSS ok. ?>></i>
                                        <?php
                                    }
                                }
                                if (!empty($item['link'])) {
...
$widgets_manager->register_widget_type(new Freshio_Elementor_Brand());
