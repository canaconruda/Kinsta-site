...
class Freshio_Call_To_Action extends Elementor\Widget_Base {

    public function get_name() {
        return 'freshio-banner';
    }

    public function get_title() {
        return __( 'Freshio Banner', 'freshio' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'Image Resolution', 'freshio' ),
                'default' => 'large',
                'condition' => [
                    'bg_image[id]!' => '',
                ],
        ...
        $this->add_control(
            'graphic_element',
            [
                'label' => __( 'Graphic Element', 'freshio' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'none' => [
                        'title' => __( 'None', 'freshio' ),
                        'icon' => 'eicon-ban',
                    ],
                    'image' => [
                        'title' => __( 'Image', 'freshio' ),
                        'icon' => 'fa fa-picture-o',
                    ],
                    'icon' => [
                        'title' => __( 'Icon', 'freshio' ),
                        'icon' => 'eicon-star',
                    ],
                ],
                'default' => 'none',
        ...
        $this->add_control(
            'icon_shape',
            [
                'label' => __( 'Shape', 'freshio' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'circle' => __( 'Circle', 'freshio' ),
                    'square' => __( 'Square', 'freshio' ),
                ],
                'default' => 'circle',
                'condition' => [
                    'icon_view!' => 'default',
        ...
        $this->add_control(
            'subtitle',
            [
                'label' => __( 'Sub title', 'freshio' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => __( 'This is the sub title', 'freshio' ),
                'placeholder' => __( 'Enter your sub title', 'freshio' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'title',
            [
                'label' => __( 'Title & Description', 'freshio' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => __( 'This is the heading', 'freshio' ),
                'placeholder' => __( 'Enter your title', 'freshio' ),
                'label_block' => true,
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'description',
            [
                'label' => __( 'Description', 'freshio' ),
                'type' => Controls_Manager::TEXTAREA,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => __( 'Lorem ipsum dolor sit amet consectetur adipiscing elit dolor', 'freshio' ),
                'placeholder' => __( 'Enter your description', 'freshio' ),
                'separator' => 'none',
                'rows' => 5,
                'show_label' => false,
            ]
        ...
        $this->add_control(
            'title_tag',
            [
                'label' => __( 'Title HTML Tag', 'freshio' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'h1' => 'H1',
                    'h2' => 'H2',
        ...
        $this->add_control(
            'button',
            [
                'label' => __( 'Button Text', 'freshio' ),
                'type' => Controls_Manager::TEXT,
                'dynamic' => [
                    'active' => true,
                ],
                'default' => __( 'Click Here', 'freshio' ),
                'separator' => 'before',
            ]
        );
        ...
        $this->add_control(
            'link_click',
            [
                'label' => __( 'Apply Link On', 'freshio' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'box' => __( 'Whole Box', 'freshio' ),
                    'button' => __( 'Button Only', 'freshio' ),
                ],
                'default' => 'button',
                'separator' => 'none',
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                ...
                'default' => 'center',
                'prefix_class' => 'elementor-cta--align-',
                'selectors' => [
        ...
        $this->add_control(
            'vertical_position',
            [
                'label' => __( 'Vertical Position', 'freshio' ),
                'type' => Controls_Manager::CHOOSE,
                'options' => [
                    'top' => [
        ...
        $this->add_control(
            'icon_primary_color',
            [
                'label' => __( 'Primary Color', 'freshio' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Secondary Color', 'freshio' ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'condition' => [
                    'graphic_element' => 'icon',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'type' => Controls_Manager::SLIDER,
                'selectors' => [
                    '{{WRAPPER}} .elementor-cta__button' => 'margin-top: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}}:hover .elementor-animated-item--move-up-2.elementor-cta__button-wrapper ' => 'height: calc({{SIZE}}{{UNIT}} + 55px);',
        ...
        $this->add_control(
            'subtitle_color',
            [
                'label' => __( 'Sub title Color', 'freshio' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'description_color',
            [
                'label' => __( 'Description Color', 'freshio' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->start_controls_section(
            'hover_effects',
            [
                'label' => __( 'Hover Effects', 'freshio' ),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'content_animation',
            [
                'label' => __( 'Hover Animation', 'freshio' ),
                'type' => Controls_Manager::SELECT,
                'groups' => [
                    [
                        'label' => __( 'None', 'freshio' ),
                        'options' => [
                            '' => __( 'None', 'freshio' ),
                        ],
                    ],
                    [
                        'label' => __( 'Entrance', 'freshio' ),
                        'options' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Animation Duration', 'freshio' ) . ' (ms)',
                'type' => Controls_Manager::SLIDER,
        ...
        $this->add_control(
            'sequenced_animation',
            [
                'label' => __( 'Sequenced Animation', 'freshio' ),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __( 'On', 'freshio' ),
                'label_off' => __( 'Off', 'freshio' ),
        ...
        $this->add_control(
            'overlay_color',
            [
                'label' => __( 'Overlay Color', 'freshio' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'effect_duration',
            [
                'label' => __( 'Transition Duration', 'freshio' ),
                'type' => Controls_Manager::SLIDER,
                'render_type' => 'template',
                'default' => [
                    'size' => 1500,
    ...
    protected function render() {
        ...
        ?>
        <<?php echo esc_html($wrapper_tag) . ' ' . freshio_elementor_get_render_attribute_string( 'wrapper', $this ); ?> class="elementor-cta--skin-cover elementor-cta elementor-freshio-banner">
        <?php if ( $print_bg ) : ?>
            <div class="elementor-cta__bg-wrapper">
                <div class="elementor-cta__bg elementor-bg" <?php echo freshio_elementor_get_render_attribute_string( 'background_image', $this ); ?>></div>
        ...
        <?php if ( $print_content ) : ?>
            ...
            <?php if ( 'image' === $settings['graphic_element'] && ! empty( $settings['graphic_image']['url'] ) ) : ?>
                <div <?php echo freshio_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                ...
                <div <?php echo freshio_elementor_get_render_attribute_string( 'graphic_element', $this ); ?>>
                    <div class="elementor-icon">
                        <?php if ( $is_new || $migrated ) :
                            ...
                            <i <?php echo freshio_elementor_get_render_attribute_string( 'icon', $this ); ?>></i>
                        <?php endif; ?>
                    </div>
                </div>
            <?php endif; ?>
            ...
            <?php if ( ! empty( $settings['subtitle'] ) ) : ?>
                <div <?php echo freshio_elementor_get_render_attribute_string( 'subtitle', $this ); ?>>
                    <?php printf('%s', $settings['subtitle']); ?>
                </div>
            <?php endif; ?>

            <?php if ( ! empty( $settings['title'] ) ) : ?>
                <<?php echo esc_html($title_tag) . ' ' . freshio_elementor_get_render_attribute_string( 'title', $this ); ?>>
                <?php printf('%s', $settings['title']); ?>
                </<?php echo esc_html($title_tag); ?>>
            <?php endif; ?>

            <?php if ( ! empty( $settings['description'] ) ) : ?>
                <div <?php echo freshio_elementor_get_render_attribute_string( 'description', $this ); ?>>
            ...
            <div class="elementor-cta__button-wrapper elementor-cta__content-item elementor-content-item <?php echo esc_attr($animation_class); ?>">
                <<?php echo esc_html($button_tag) . ' ' . freshio_elementor_get_render_attribute_string( 'button', $this ); ?>>
                <span>
...
$widgets_manager->register_widget_type(new Freshio_Call_To_Action());
