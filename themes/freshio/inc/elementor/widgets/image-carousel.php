...
class Freshio_Image_Carousel extends Elementor\Widget_Base
{

    public function get_name()
    {
        return 'freshio-image-carousel';
    }

    public function get_title()
    {
        return __('Freshio Image Carousel', 'freshio');
    }
    ...
    public function get_script_depends() {
        return [ 'freshio-elementor-image-carousel', 'slick' ];
    }
...
$widgets_manager->register_widget_type(new Freshio_Image_Carousel());
