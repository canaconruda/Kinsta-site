 ...
 * @since 1.0.0
 */
class Freshio_Elementor_Products_Tabs extends Elementor\Widget_Base {
	...
	public function get_title() {
		return esc_html__( 'Products Tabs', 'freshio' );
	}
	...
	public function get_script_depends() {
		return [ 'freshio-elementor-product-tab', 'slick' ];
	}
	...
	protected function _register_controls() {
		...
		$repeater->add_control(
			'tab_title',
			[
				'label'       => esc_html__( 'Tab Title', 'freshio' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => esc_html__( '#Product Tab', 'freshio' ),
				'placeholder' => esc_html__( 'Product Tab Title', 'freshio' ),
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'options' => [
					...
					'title'      => __( 'Product Title', 'freshio' ),
					'rand'       => __( 'Random', 'freshio' ),
				],
			]
		);
		...
		$repeater->add_control(
			'order',
			[
				'label'   => __( 'Order', 'freshio' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'desc',
				'options' => [
					'asc'  => __( 'ASC', 'freshio' ),
					'desc' => __( 'DESC', 'freshio' ),
				],
			]
		);
		...
		$repeater->add_control(
			'cat_operator',
			[
				'label'     => __( 'Category Operator', 'freshio' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => 'IN',
				'options'   => [
					'AND'    => __( 'AND', 'freshio' ),
					'IN'     => __( 'IN', 'freshio' ),
					'NOT IN' => __( 'NOT IN', 'freshio' ),
				],
				'condition' => [
					'categories!' => ''
				],
		...
		$repeater->add_control(
			'product_type',
			[
				'label'   => __( 'Product Type', 'freshio' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'newest',
				'options' => [
					'newest'       => __( 'Newest Products', 'freshio' ),
					'on_sale'      => __( 'On Sale Products', 'freshio' ),
					'best_selling' => __( 'Best Selling', 'freshio' ),
					'top_rated'    => __( 'Top Rated', 'freshio' ),
					'featured'     => __( 'Featured Product', 'freshio' ),
				],
			]
		);
		...
		$repeater->add_control(
			'product_layout',
			[
				'label'   => __( 'Product Layout', 'freshio' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'grid',
				'options' => [
					'grid' => __( 'Grid', 'freshio' ),
					'list' => __( 'List', 'freshio' ),
				],
			]
		);
		...
		$repeater->add_control(
			'list_layout',
			[
				'label'     => __( 'List Layout', 'freshio' ),
				'type'      => Controls_Manager::SELECT,
				'default'   => '1',
				'options'   => [
					'1' => __( 'Style 1', 'freshio' ),
					'2' => __( 'Style 2', 'freshio' ),
					'3' => __( 'Style 3', 'freshio' ),
					'4' => __( 'Style 4', 'freshio' ),
					'5' => __( 'Style 5', 'freshio' ),
				],
				'condition' => [
					'product_layout' => 'list'
				]
		...
		$this->add_control(
			...
			[
				...
				'default'     => [
					[
						'tab_title' => __( '#Product Tab 1', 'freshio' ),
					],
					[
						'tab_title' => __( '#Product Tab 2', 'freshio' ),
					]
				],
		...
		$this->start_controls_section(
			'section_product',
			[
				'label' => __( 'Product', 'freshio' ),
			]
		);
		$this->add_responsive_control(
			'product_gutter',
			[
				'label'      => __( 'Gutter', 'freshio' ),
		...
		$this->add_responsive_control(
			'header_margin',
			[
				'label'      => __( 'Spacing Between Item', 'freshio' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
		...
		$this->add_responsive_control(
			...
			[
				'label'      => __( 'Vertical Padding', 'freshio' ),
				'type'       => Controls_Manager::SLIDER,
				'range'      => [
					'px' => [
						'min' => 0,
        ...
        <div class="elementor-tabs" role="tablist">
            <div class="elementor-tabs-wrapper">
				...
				foreach ( $tabs as $index => $item ) :
					...
					?>
                    <div <?php echo freshio_elementor_get_render_attribute_string( $tab_title_setting_key, $this ); // WPCS: XSS ok.
					?>><?php echo esc_html( $item['tab_title'] ); ?></div>
				<?php endforeach; ?>
            </div>
            <div <?php echo freshio_elementor_get_render_attribute_string( 'data-carousel', $this ); // WPCS: XSS ok.
			?>>
				<?php
				foreach ( $tabs as $index => $item ) :
					$tab_count = $index + 1;
					...
					?>
                    <div <?php echo freshio_elementor_get_render_attribute_string( $tab_content_setting_key, $this ); // WPCS: XSS ok.
					?>>
	...
	protected function add_control_carousel( $condition = array() ) {
		...
		$this->add_control(
			...
			[
				'label'        => __( 'Border Wrapper', 'freshio' ),
				'type'         => Controls_Manager::SWITCHER,
		...
		$this->add_control(
            'effect_horizontal',
            [
                'label' => __( 'Effect Horizontal', 'freshio' ),
                'type'  => Controls_Manager::SWITCHER,
...
$widgets_manager->register_widget_type( new Freshio_Elementor_Products_Tabs() );
