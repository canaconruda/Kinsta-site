...
class Freshio_Elementor_Team_Box extends Elementor\Widget_Base
{
    ...
    {
        return esc_html__('Team Box', 'freshio');
    }
    ...
    protected function _register_controls()
    {
        ...
        $this->add_control(
            'teams',
            [
                'label' => esc_html__('Team Item', 'freshio'),
        ...
        $this->add_control(
            'description',
            [
                'label' => esc_html__('Description', 'freshio'),
        ...
        $this->add_control(
            'facebook',
            [
                'label' => esc_html__('Facebook', 'freshio'),
                'placeholder' => esc_html__('https://www.facebook.com/opalwordpress', 'freshio'),
        ...
        $this->add_control(
            'twitter',
            [
                'label' => esc_html__('Twitter', 'freshio'),
                'placeholder' => esc_html__('https://twitter.com/opalwordpress', 'freshio'),
        ...
        $this->add_control(
            'youtube',
            [
                'label' => esc_html__('Youtube', 'freshio'),
                'placeholder' => esc_html__('https://www.youtube.com/user/WPOpalTheme', 'freshio'),
        ...
        $this->add_control(
            'google',
            [
                'label' => esc_html__('Google', 'freshio'),
                'placeholder' => esc_html__('https://plus.google.com/u/0/+WPOpal', 'freshio'),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Image', 'freshio'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
        ...
        $this->add_control(
            'image_border_radius',
            [
                'label'      => esc_html__( 'Border Radius', 'freshio' ),
                'type'       => Controls_Manager::DIMENSIONS,
                'size_units' => [ 'px', '%' ],
                'selectors'  => [
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__('Hover Color', 'freshio'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'job_text_color',
            [
                'label' => esc_html__('Text Color', 'freshio'),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => esc_html__('Icon Social', 'freshio'),
                'tab' => Controls_Manager::TAB_STYLE,
            ]
        );
                            ...
                            <?php if (!empty($settings[$key])) : ?>
                                <li class="social">
                                    <a href="<?php echo esc_url($settings[$key]) ?>">
                                        <i class="freshio-icon-<?php echo esc_attr($social); ?>"></i>
                                    </a>
                                </li>
                            <?php endif; ?>
                        <?php endforeach; ?>
...
$widgets_manager->register_widget_type(new Freshio_Elementor_Team_Box());
