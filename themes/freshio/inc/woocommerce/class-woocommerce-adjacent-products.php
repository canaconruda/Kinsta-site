<?php
/**
 * Freshio WooCommerce Adjacent Products Class
 *
 * @package  freshio
 * @since    2.4.3
 */
...
if ( ! class_exists( 'Freshio_WooCommerce_Adjacent_Products' ) ) :

	/**
	 * The Freshio WooCommerce Adjacent Products Class
	 */
	class Freshio_WooCommerce_Adjacent_Products {
		...
		private function query_wc() {
			...
			$products = wc_get_products( apply_filters( 'freshio_woocommerce_adjacent_query_args', $args ) );
