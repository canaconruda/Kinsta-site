...
if (!class_exists('Freshio_WooCommerce_Clever')) :


    class Freshio_WooCommerce_Clever {
        ...
        public function add_hook() {
            if (function_exists('woosq_init') && get_option('woosq_button_position') == "0") {
                add_action('freshio_woocommerce_product_loop_action', [$this, 'quickview_button'], 15);
            }

            if (function_exists('wooscp_init') && get_option('_wooscp_button_archive') == "0") {
                add_action('freshio_woocommerce_product_loop_action', [$this, 'compare_button'], 10);
            }

            if (function_exists('woosw_init') && get_option('woosw_button_position_archive') == "0") {
                add_action('freshio_woocommerce_product_loop_action', [$this, 'wishlist_button'], 5);
            }
        }
    ...
    return new Freshio_WooCommerce_Clever();
endif;
